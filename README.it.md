...
> 🍎 **Solo macOS** — Supporto Windows e Linux in arrivo.
...
Tutto qui! Apri Hive dalla cartella Applicazioni e indirizzalo a un repository git.
...
- **Supporto multipiattaforma** — Build per Windows e Linux
